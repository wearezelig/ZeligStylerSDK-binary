...
Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => "https://storage.googleapis.com/ios-widget-sdk-zelig-prod/ZeligStylerSDK-1.0.3.xcframework.zip",
    :type => :zip,
    :sha256 => "98dd6609210ecf2b64e1b0a720bbed8403094f23accf62522805efb28d2c7a54"
  }
