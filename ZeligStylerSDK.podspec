...
Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => "https://storage.googleapis.com/ios-widget-sdk-zelig-prod/ZeligStylerSDK-1.0.4.xcframework.zip",
    :type => :zip,
    :sha256 => "6211e804d2f830abaa6c03689d4b6988d4bf2c1f72effc40fb696fb4ee6bdb2e"
  }
