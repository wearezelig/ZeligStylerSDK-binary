...
Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => "https://storage.googleapis.com/ios-widget-sdk-zelig-dev/ZeligStylerSDK-1.0.3.xcframework.zip",
    :type => :zip,
    :sha256 => "119c5f5f7beddfdde539921c77cf60398cc0f39fc1e4420ec8b8be273ed3d1f8"
  }
