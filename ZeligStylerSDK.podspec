...
Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => "https://storage.googleapis.com/ios-widget-sdk-zelig-prod/ZeligStylerSDK-1.0.6.xcframework.zip",
    :type => :zip,
    :sha256 => "1441359326f769cb7be72511f4c8da710d0aa250f652270bbacd3feeda1bd037"
  }
