...
Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => "https://storage.googleapis.com/ios-widget-sdk-zelig-dev/ZeligStylerSDK-1.0.2.xcframework.zip",
    :type => :zip,
    :sha256 => "ad300b91f6e333a73b01bf5de45181462f5a05aecf04024517169539432e0430"
  }
