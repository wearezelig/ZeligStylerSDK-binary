...
Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => "https://storage.googleapis.com/ios-widget-sdk-zelig-prod/ZeligStylerSDK-1.0.2.xcframework.zip",
    :type => :zip,
    :sha256 => "e585faede808334cb525e4f388fbf7fafe48214c48e76bca8369d0e0eb1a72c7"
  }
