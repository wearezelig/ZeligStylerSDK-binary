...
Pod::Spec.new do |spec|
  ...
  spec.source = {
    :http => "https://storage.googleapis.com/ios-widget-sdk-zelig-prod/ZeligStylerSDK-1.0.1.xcframework.zip",
    :type => :zip,
    :sha256 => "1e6bd3ce1773c1594f845741e0d0afda896238bff8c7cefb41ef780c1fbc4a67"
  }
