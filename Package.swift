...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ZeligStylerSDK",
            url: "https://storage.googleapis.com/ios-widget-sdk-zelig-prod/ZeligStylerSDK-1.0.6.xcframework.zip",
            checksum: "1441359326f769cb7be72511f4c8da710d0aa250f652270bbacd3feeda1bd037"
        )
    ]
)
