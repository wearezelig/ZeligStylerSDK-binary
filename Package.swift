...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ZeligStylerSDK",
            url: "https://zelig-sdk.oss-cn-beijing.aliyuncs.com/ZeligStylerSDK-1.0.2.xcframework.zip",
            checksum: "27f1565f5379cab31ef454bbba140d9ef154f2763c23427577a73daa8d502b71"
        )
    ]
)
